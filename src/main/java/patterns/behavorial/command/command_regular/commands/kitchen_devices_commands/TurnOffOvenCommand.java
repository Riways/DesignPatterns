...
public class TurnOffOvenCommand implements Command {

	KitchenDevices kitchenDevices;
	
	
	public TurnOffOvenCommand(KitchenDevices kitchenDevices) {
		super();
	...
	@Override
	public void execute() {
		kitchenDevices.turnOffOven();
	}
	
	@Override
	public void undo() {
		kitchenDevices.turnOnOven();
	}
